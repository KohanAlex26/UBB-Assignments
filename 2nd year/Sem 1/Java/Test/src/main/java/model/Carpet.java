...
public class Carpet implements Identifiable<Integer>,java.io.Serializable {
    ...
    public Carpet(String name, int dimension, String color, int price) {
        this.name = name;
        this.color = color;
    ...
    public Carpet(String name, int dimension) {
        this.name = name;
        this.dimension = dimension;
        status= carpetStatus.New;
    }

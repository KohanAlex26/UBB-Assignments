...
public class OrderFileRepository extends OrderInMemoryRepository {
    ...
    public OrderFileRepository(String s, tractoareRepository tractoareRepository){
        this.FileName=s;
        ...
        try(BufferedReader br=new BufferedReader(new FileReader(FileName)))
        {
            ...
            while((line=br.readLine())!=null)
            {
                ...
                try{
                    ...
                    Tractore tractore = tractoareRepository.findbyId(carpetId);
                    Order obj=new Order(orderId,el[2],el[3],el[4], tractore);
                    super.add(obj);
                }

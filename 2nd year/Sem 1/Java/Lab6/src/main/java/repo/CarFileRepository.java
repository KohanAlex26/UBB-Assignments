...
import java.io.PrintWriter;
    ...
    public CarFileRepository(String s){
        this.FileName=s;
        readFromFile();
    }
        ...
        try(BufferedReader br=new BufferedReader(new FileReader(FileName)))
        {
            ...
            while((line=br.readLine())!=null)
            {
                ...
                try{
                    ...
                    carStatus status= carStatus.valueOf(carStatus.class,el[5]);
                    Car c=new Car(id,el[1],el[2],el[3],Integer.parseInt(el[4]));
                    c.setStatus(status);
                    super.add(c);
                }
    ...
    private void writeToFile()
    {
        try(PrintWriter pw=new PrintWriter(FileName))
        {
            ...
            for(Car obj:findall())
            {
                pw.println(obj.getId()+";"+obj.getModel()+";"+obj.getColor()+";"+obj.getBrand()+";"+obj.getSeats()+";"+obj.getStatus());
            }
        }
        catch (IOException e)
        {
    ...
    @Override
    public void update(Integer integer,Car el)
    {

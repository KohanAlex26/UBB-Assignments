...
public class TrainerController {
    ...
    TrainersDTO getTrainersFromRepository() {
        logger.trace("getAllTrainers - method entered");
        List<Trainer> trainers = trainerService.getTrainersFromRepository();
        TrainersDTO trainersDTO = new TrainersDTO(trainerConverter.convertModelsToDTOs(trainers));
        logger.trace("getAllTrainers: " + trainers);
        return trainersDTO;
    }
...
//    }
    ...
    void addTrainer(@RequestBody TrainerDTO trainerDTO) {
        ...
        Trainer trainer = trainerConverter.convertDtoToModel(trainerDTO);
